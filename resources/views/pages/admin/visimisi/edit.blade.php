...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-4">
            <h5 class="card-header">Edit Visi Misi</h5>

            <hr class="my-0" />
            <div class="card-body">
                <form action="{{ route('admin.visimisi.update', $visimisi->id) }}" id="formAccountSettings" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea class="form-control  @error('visi') is-invalid @enderror" id="visi"
                                name="visi" value="{{ old('visi') }}" placeholder="">{{ $visimisi->visi }}</textarea>
                            @error('visi')
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea class="form-control  @error('misi') is-invalid @enderror" id="misi"
                                name="misi" value="{{ old('misi') }}" placeholder="">{{ $visimisi->misi }}</textarea>
                            @error('misi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
