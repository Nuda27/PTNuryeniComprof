...
Route::prefix('admin')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/whychoose/{id}/create', [WhychooseController::class, 'createWhyItem'])->name('whyItem.create');
        Route::post('/whychoose/{id}/store', [WhychooseController::class, 'storeWhyItem'])->name('whyItem.store');
